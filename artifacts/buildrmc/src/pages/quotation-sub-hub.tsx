    ...
    <div className="flex h-full gap-4 bg-[#f8fafc]">
      ...
      <div className="w-64 bg-white border rounded-lg shadow-sm flex flex-col overflow-hidden shrink-0">
        ...
        <div className="flex-1 overflow-auto p-2">
          <Accordion type="multiple" defaultValue={["quotation"]} className="w-full space-y-2">
      ...
      <div className="flex-1 flex flex-col min-w-0 pr-2 overflow-auto pb-10">
        <div className="mb-3 flex items-center gap-3 bg-white p-2 px-3 rounded-lg border shadow-sm shrink-0">
          <h2 className="text-[12px] font-black text-gray-900 uppercase tracking-tight">Quotation Management</h2>
          ...
          <nav className="text-[10px] text-muted-foreground flex items-center gap-1 uppercase font-bold tracking-wider">
            ...
            <ChevronRight className="h-2.5 w-2.5" />
            <span className="text-[#1e40af]">Quotation Management</span>
          </nav>
        </div>
        <QuotationList />
      </div>
