    ...
    <div className="flex h-full gap-4 bg-[#f8fafc]">
            ...
            <AccordionItem value="customer" className="border-none border rounded-lg bg-white shadow-sm overflow-hidden">
              ...
              <AccordionContent className="bg-gray-50/50 pb-2 border-t">
                <div className="flex flex-col space-y-1 mt-2 px-2">
                  ...
                  <Link href="/customer-po/customer"><div className="text-xs font-medium text-gray-600 hover:text-[#1e40af] hover:bg-white border border-transparent hover:border-gray-200 py-2 px-3 rounded-md transition-all cursor-pointer shadow-sm hover:shadow">Customer List</div></Link>
            ...
            <AccordionItem value="sales-order" className="border-none border rounded-lg bg-white shadow-sm overflow-hidden">
              ...
              <AccordionContent className="bg-gray-50/50 pb-2 border-t">
                <div className="flex flex-col space-y-1 mt-2 px-2">
                  ...
                  <Link href="/customer-po/sales-order"><div className={`text-xs font-medium py-2 px-3 rounded-md transition-all cursor-pointer shadow-sm ${location === '/customer-po/sales-order' ? 'bg-[#1e40af] text-white' : 'text-gray-600 hover:text-[#1e40af] hover:bg-white border border-transparent hover:border-gray-200 hover:shadow'}`}>Sales Order List</div></Link>
            ...
            <AccordionItem value="scheduling" className="border-none border rounded-lg bg-white shadow-sm overflow-hidden">
              ...
              <AccordionContent className="bg-gray-50/50 pb-2 border-t">
                <div className="flex flex-col space-y-1 mt-2 px-2">
                  ...
                  <Link href="/customer-po/scheduling"><div className="text-xs font-medium text-gray-600 hover:text-[#1e40af] hover:bg-white border border-transparent hover:border-gray-200 py-2 px-3 rounded-md transition-all cursor-pointer shadow-sm hover:shadow">Scheduling List</div></Link>
                </div>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="quotation" className="border-none border rounded-lg bg-white shadow-sm overflow-hidden">
              ...
              <AccordionContent className="bg-gray-50/50 pb-2 border-t">
                <div className="flex flex-col space-y-1 mt-2 px-2">
                  ...
                  <Link href="/customer-po/quotation"><div className="text-xs font-medium text-gray-600 hover:text-[#1e40af] hover:bg-white border border-transparent hover:border-gray-200 py-2 px-3 rounded-md transition-all cursor-pointer shadow-sm hover:shadow">Quotation List</div></Link>
                </div>
              </AccordionContent>
            </AccordionItem>
      ...
      <div className="flex-1 flex flex-col min-w-0 pr-2 overflow-auto pb-10">
        <div className="mb-4 flex items-center gap-3 bg-white p-2 px-3 rounded-lg border shadow-sm shrink-0">
          <h2 className="text-[12px] font-black text-gray-900 uppercase tracking-tight">Sales Order Management</h2>
          ...
          <nav className="text-[10px] text-muted-foreground flex items-center gap-1 uppercase font-bold tracking-wider">
            ...
            <ChevronRight className="h-2.5 w-2.5" />
            <span className="text-[#1e40af]">Sales Order Management</span>
          </nav>
        </div>
        <SalesOrderList />
      </div>
