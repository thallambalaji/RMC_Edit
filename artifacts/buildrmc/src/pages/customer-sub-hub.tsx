            ...
            <AccordionItem value="quotation" className="border-none border rounded-lg bg-white shadow-sm overflow-hidden">
              ...
              <AccordionContent className="bg-gray-50/50 pb-2 border-t">
                <div className="flex flex-col space-y-1 mt-2 px-2">
                  ...
                  <Link href="/customer-po/quotation/list"><div className="text-xs font-medium text-gray-600 hover:text-[#ea580c] hover:bg-white border border-transparent hover:border-gray-200 py-2 px-3 rounded-md transition-all cursor-pointer shadow-sm hover:shadow">Quotation List</div></Link>
                </div>
              </AccordionContent>
            </AccordionItem>
