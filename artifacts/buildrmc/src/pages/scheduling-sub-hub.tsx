              ...
              <AccordionContent className="bg-slate-50/20 pb-2 border-t border-slate-50">
                <div className="flex flex-col space-y-1 mt-2 px-2">
                  <Link href="/customer-po/sales-order/new"><div className="text-xs font-medium text-gray-600 hover:text-[#ea580c] hover:bg-white border border-transparent hover:border-gray-200 py-2 px-3 rounded-md transition-all cursor-pointer shadow-sm hover:shadow">Add Sales Order</div></Link>
                   <Link href="/customer-po/sales-order"><div className="text-xs font-medium text-gray-600 hover:text-[#ea580c] hover:bg-white border border-transparent hover:border-gray-200 py-2 px-3 rounded-md transition-all cursor-pointer shadow-sm hover:shadow">Sales Order List</div></Link>
