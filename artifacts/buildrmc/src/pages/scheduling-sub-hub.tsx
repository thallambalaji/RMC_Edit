...
import { ChevronRight, CalendarPlus, ListTodo } from "lucide-react";

export default function SchedulingSubHub() {
  const actions = [
    {
      href: "/customer-po/scheduling/new",
      label: "Add Scheduling",
      icon: CalendarPlus,
      color: "bg-green-500 hover:bg-green-600",
    },
    {
      href: "/customer-po/scheduling/list",
      label: "Scheduling List",
      icon: ListTodo,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center text-gray-400 text-sm italic">
        Manage your dispatch schedules and pump allocations
      </div>
    </div>
  );
}
