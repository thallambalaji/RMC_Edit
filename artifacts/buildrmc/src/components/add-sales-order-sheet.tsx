...
export function AddSalesOrderSheet({ isOpen, onClose }: AddSalesOrderSheetProps) {
    ...
    <Sheet open={isOpen} onOpenChange={(open) => {
      ...
      <SheetContent className="w-[95vw] max-w-4xl max-h-[90vh] overflow-y-auto flex flex-col gap-0 p-0 rounded-xl">
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="p-4">
            <form id="add-so-form" onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center space-x-2 pt-2">
                ...
                />
                <label htmlFor="add-rate-tax" className="text-[11px] font-bold text-gray-600">Rate Include Tax?</label>
              </div>
