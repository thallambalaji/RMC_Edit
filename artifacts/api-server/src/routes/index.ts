...
import inventoryTicketsRouter from "./inventoryTickets";
import storeInventoryRouter from "./storeInventory.js";
...
router.use(inventoryTicketsRouter);
router.use(storeInventoryRouter);
