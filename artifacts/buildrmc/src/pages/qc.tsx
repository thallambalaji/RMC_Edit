  ...
  const cards = [
    {
      ...
      icon: <FileText className="h-5 w-5 text-[#ea580c]" />,
      iconBg: "bg-orange-50/40",
      links: [
      ...
      <div className="space-y-4 flex-grow flex flex-col min-h-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 print:hidden shrink-0">
          <div className="bg-white border rounded-lg p-3 flex items-center gap-3 shadow-sm">
            <div className="p-2 bg-orange-50/40 rounded-full"><Layers className="h-4 w-4 text-[#ea580c]" /></div>
            <div>
          ...
          <div className="bg-[#ea580c] rounded-lg p-3 flex items-center gap-3 shadow-sm text-white">
